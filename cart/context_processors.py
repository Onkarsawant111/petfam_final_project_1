...
# If you have a shopping cart, a context processor can automatically provide the current cart's contents to all your templates, allowing you to display cart details in the or footer without passing it manually from every view.